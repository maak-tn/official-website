...
function About() {
    ...
    return (
        <section className='px-4 max-w-[var(--max-width)] flex flex-col gap-24 items-start lg:py-24 py-16 lg:px-0 mx-auto'>
            <SectionTitle title='what We do?' subTitle='work' />
            <div className='w-full h-full flex flex-col gap-24 lg:justify-center'>
                <div className='lg:text-2xl lg:leading-loose lg:text-left text-justify lg:tracking-wide'>
                    <p>
                        For over 6 years, we have helped small businesses and startups save up to 70% on web development costs through strategic use of <strong>no-code tools and custom development</strong>.
                        From e-commerce websites to business automation, our proven hybrid approach delivers <strong>enterprise-grade solutions at a fraction of traditional development costs</strong>.
                    </p>
