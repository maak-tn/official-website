                    ...
                    <div className='flex gap-1 flex-wrap'>
                        {
                            project.tags.map((tag: string, index: number) => (
                                <span key={index} className='bg-black text-white opacity-70 px-2 py-1 rounded-lg'>#{tag}</span>
                            ))
                        }
                    </div>
                    <div className='flex gap-1 flex-wrap'>
                        {
                            project.techStack.map((tech: string, index: number) => (
                                <span key={index} className='bg-black text-white opacity-70 px-2 py-1 rounded-lg'>#{tech}</span>
                            ))
                        }
                    </div>
                </div>
